var arrayParam, carouseriaHeight, carouseriaLoop, carouseriaDirection, carouseriaAutoPlay, carouseriaIndex, carouseriaNav, navContent, indexContent, indexContentChild, autoPlay, slideReady, mainCarousel, innerElement, focusElem, maxElem;
...
function visualIndex(num, setParams) {
    ...
    setParams == "vertical" ? indexContent.setAttribute("class", "carouseria-index verti") : indexContent.setAttribute("class", "carouseria-index hori");
    ...
    for (var i = 0; i < indexContentChild.length; i++) {
        indexContentChild[i].style.opacity = 0.9;
...
function fadeIn(elem) {
    elem.style.opacity = parseFloat(elem.style.opacity) + 0.8;
...
function next() {
    if (slideReady) {
        ...
        if (nowCount < maxElem) {
            slideReady = !1;
            changeFocus(innerElement[nowCount + 1], !1)
        } else {
            if (nowCount == maxElem && carouseriaLoop) {
                slideReady = !1;
                changeFocus(innerElement[0], !1)
            }
        }
    }
}
...
function prev() {
    if (slideReady) {
        ...
        if (nowCount > 0) {
            slideReady = !1;
            changeFocus(innerElement[nowCount - 1], !0)
        } else {
            if (nowCount == 0 && carouseriaLoop) {
                slideReady = !1;
                changeFocus(innerElement[maxElem], !0)
            }
        }
    }
}
